...
%============================ (a) BASELINE ============================
\node[lbl, font=\normalsize\itshape ,anchor=west] at (0,0.95) {(a) Baseline: every stage round-trips through HBM};
...
%============================ (b) FUSED ============================
\node[lbl, font=\normalsize\itshape,anchor=west] at (0,-1.35) {(b) Fused: one read, one pass --- the transform is recomputed in registers};
